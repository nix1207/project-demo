                ...
                <div class="col">
                    ...
                    <div class="widget-item">
                        <div class="footer-logo-area">
                            <a href="index.html">
                                <img class="logo-main" src="{{ asset("frontend-access") }}/assets/img/logo-light.png" alt="Logo" />
                            </a>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="payment-method">
                        <img src="{{ asset("frontend-access") }}/assets/img/icons/payment.webp" alt="Image-HasTech">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="product-quick-view-content">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="thumb">
                        <img src="{{ asset("frontend-access") }}/assets/img/shop/quick-view1.jpg" alt="Alan-Shop">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="content">
